...
class ModulosSeeder extends Seeder 
{
	...
	public function run()
	{
		...
		$modulos[] = ['nombre' => 'tienda', 'ruta' => 'tienda', 'permisos' => []];
		$modulos[] = ['nombre' => 'tienda', 'ruta' => 'tienda', 'permisos' => [0]];
		$modulos[] = ['nombre' => 'Persona', 'ruta' => 'Persona', 'permisos' => [1,2,3,4,0]];
		$modulos[] = ['nombre' => 'Mascota', 'ruta' => 'Mascota', 'permisos' => [1,2,3,4]];
